                          ...
                          <>
                            ...
                            <div className='grid grid-cols-2 lg:grid-cols-4 gap-3'>
                              ...
                              <div className='rounded-xl border bg-background/50 p-3'>
                                ...
                                <p className='text-lg font-semibold'>
                                  LKR {dashboardStats.metrics.totalSpent.toFixed(2)}
                                </p>
                              </div>
                              <div className='rounded-xl border bg-background/50 p-3'>
                            ...
                            <div className='grid grid-cols-2 lg:grid-cols-4 gap-3'>
                              <div className='rounded-xl border bg-background/50 p-3'>
                                ...
                                <p className='text-lg font-semibold'>
                                  LKR {dashboardStats.metrics.weeklyAverageOrderValue.toFixed(2)}
                                </p>
                              ...
                              <div className='rounded-xl border bg-background/50 p-3'>
                                ...
                                <p className='text-lg font-semibold'>
                                  LKR {dashboardStats.metrics.monthlyAverageOrderValue.toFixed(2)}
                                </p>
                                <p className='text-xs text-muted-foreground mt-1'>
                              ...
                              <div className='rounded-xl border bg-background/50 p-4 space-y-3'>
                                ...
                                <div className='space-y-2 text-sm'>
                                  ...
                                  <div className='flex items-center justify-between'>
                                    ...
                                    <span className='font-semibold'>
                                      LKR {dashboardStats.metrics.failedPaymentAmount.toFixed(2)}
                                    </span>
                                  </div>
                                  <div className='flex items-center justify-between'>
                                  ...
                                  <div className='flex items-center justify-between'>
                                    ...
                                    <span className='font-semibold'>
                                      LKR {dashboardStats.metrics.averageOrderValue.toFixed(2)}
                                    </span>
                                  </div>
                                  <div className='flex items-center justify-between'>
                                  ...
                                  <div className='space-y-2'>
                                    {dashboardStats.topProducts.map((product) => (
                                      ...
                                      >
                                        ...
                                        <span>LKR {product.totalAmount.toFixed(2)}</span>
                                      </div>
                                    ))}
                                  </div>
                                )}
